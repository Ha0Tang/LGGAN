...
class LGGANGenerator(BaseNetwork):
    ...
    def forward(self, input, z=None):
        ...
        x_feature_local = F.relu(self.deconv4_norm_local(self.deconv4_local(x_local))) # print(x_feature_local.size()) [1, 64, 256, 512]

        # for i in range(self.opt.label_nc):
        #     globals()['feature_' + str(i)] = x_feature_local.cuda() * eval('label_64_%d'% (i)).cuda()
        ...
        feature_combine= torch.cat((feature_0, feature_1, feature_2, feature_3, feature_4, feature_5, feature_6, feature_7, feature_8, feature_9, feature_10, feature_11,
                                    ...
                                    feature_32,feature_33,feature_34), 0)
        ...
        valid_index = torch.tensor([if_all_zero(label_0), if_all_zero(label_1), if_all_zero(label_2),if_all_zero(label_3),if_all_zero(label_4), if_all_zero(label_5),
                                    ...
                                    if_all_zero(label_30),if_all_zero(label_31),if_all_zero(label_32),if_all_zero(label_33),if_all_zero(label_34)])
        # print(valid_index)
        ...
        combine_local = torch.cat((result_0, result_1, result_2, result_3, result_4,result_5 ,result_6 ,result_7 , result_8 , result_9 , result_10 , \
                                   result_11 ,result_12 , result_13 , result_14 , result_15 , result_16 , result_17 , result_18 , result_19 , result_20, \
                                   result_21 , result_22 , result_23 , result_24 , result_25 , result_26 , result_27 , result_28 , result_29 , result_30, \
                                   result_31 , result_32 , result_33 , result_34), 1)
        ...
        return final, result_global, result_local, label_3_0, label_3_1, label_3_2, label_3_3, label_3_4, label_3_5, label_3_6, label_3_7, label_3_8, \
               ...
               label_3_21,label_3_22, label_3_23, label_3_24, label_3_25, label_3_26, label_3_26, label_3_28, label_3_29, label_3_30, label_3_31, \
               ...
               result_11 ,result_12 , result_13 , result_14 , result_15 , result_16 , result_17 , result_18 , result_19 , result_20, \
               result_21 , result_22 , result_23 , result_24 , result_25 , result_26 , result_27 , result_28 , result_29 , result_30, \
               result_31 , result_32 , result_33 , result_34, feature_score, target.cuda(), valid_index.float().cuda(), attention_global, attention_local
